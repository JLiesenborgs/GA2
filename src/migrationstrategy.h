...
public:
	...
	errut::bool_t check(const std::vector<std::shared_ptr<Population>> &populations) { return "Not implemented in base class"; } 
	...
	// way at this point
	errut::bool_t migrate(size_t generation, std::vector<std::shared_ptr<Population>> &populations) { return "Not implemented in base class"; }
};
